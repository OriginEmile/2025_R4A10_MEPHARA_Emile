...
type StudentRepository = FindMany<Student> & FindOne<Student> & Create<Student> & Update<Student> & Delete;
type CourseRepository = FindMany<Course> & FindOne<Course> & Create<Course> & Update<Course>;
